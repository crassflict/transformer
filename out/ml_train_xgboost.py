# out/ml_train_xgboost.py
"""
Entraîne un modèle XGBoost sur le dataset construit par ml_build_dataset.py.

- lit data/dataset_features.parquet
- utilise FEATURE_COLUMNS comme X
- LABEL_COLUMN comme y
- sauvegarde :
    - data/model_xgb.json
    - data/xgb_report.txt
"""
...
MODEL_FILE = DATA_DIR / "model_xgb.json"
REPORT_FILE = DATA_DIR / "xgb_report.txt"


def main() -> None:
    print(f"Loading dataset from {FEATURES_FILE} ...")
    ...
    X_train, X_test, y_train, y_test = train_test_split(
        ...
        y,
        test_size=0.3,
        shuffle=False,  # série temporelle : on évite de mélanger
    )
